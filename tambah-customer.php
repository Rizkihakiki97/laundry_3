...
if (isset($_POST['simpan'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO customer (customer_name, phone, address)
            VALUES ('$customer_name','$phone','$address')");

    header("location:customer.php?tambah=berhasil");
}

$id  = isset($_GET['edit']) ? $_GET['edit'] : ''; //8
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE customer SET customer_name='$customer_name',
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="customer_name" placeholder="Nama Pelanggan"
                                                        class="form-control"
                                                        value="<?php echo !empty($_GET['edit']) ? $rowEdit['customer_name'] : '' ?>">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="phone" placeholder="Telepon"
                                                        class="form-control"
                                                        value="<?php echo !empty($_GET['edit']) ? $rowEdit['phone'] : '' ?>">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="address" placeholder="Alamat"
                                                        class="form-control"
                                                        value="<?php echo !empty($_GET['edit']) ? $rowEdit['address'] : '' ?>">
                                                </div>
                                            </div>
                                            <div class="mb-3">
