...
$query  = "SELECT customer.customer_name,  trans_order.* 
FROM trans_order 
LEFT JOIN customer ON customer.id = trans_order.id_customer WHERE 1";
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php $no = 1;
                                                // for ($i = 0; $i < mysqli_fetch_assoc($queryUser); $i++) {
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo date("Y-m-d", strtotime($rowTrans['tanggal_laundry'])) ?></td>
                                                        <td>
                                                            <?php
