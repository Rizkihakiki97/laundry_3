...
if (isset($_POST['simpan'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO paket (nama_paket, harga, deskripsi)
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE paket SET nama_paket='$nama_paket',
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="nama_paket" placeholder="Nama Paket"
                                                        class="form-control"
                                                        value="<?php echo !empty($_GET['edit']) ? $rowEdit['nama_paket'] : '' ?>">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="harga" placeholder="Harga"
                                                        class="form-control"
                                                        value="<?php echo !empty($_GET['edit']) ? $rowEdit['harga'] : '' ?>">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="deskripsi" placeholder="Deskripsi"
                                                        class="form-control"
                                                        value="<?php echo !empty($_GET['edit']) ? $rowEdit['deskripsi'] : '' ?>">
                                                </div>
                                            </div>
                                            <div class="mb-3">
